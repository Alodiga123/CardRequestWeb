...
@FacesConverter("zipZoneConverter")
public class ZipZoneConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        ...
        try {
            ...
            zipZone = utilsEJB.loadZipZone(request);

        } catch (RegisterNotFoundException ex) {
            Logger.getLogger(ZipZoneConverter.class.getName()).log(Level.SEVERE, null, ex);
